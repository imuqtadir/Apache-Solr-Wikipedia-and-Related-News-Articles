...
<%
    ...
    String l = objSolr_Query.fetchqueryresults(request.getParameter("q"));

    JsonParser jsonParser = new JsonParser();
    JsonArray userarray = jsonParser.parse(l).getAsJsonArray();
...
<html>
    ...
    <body>
        <table style="width: 80%" align="center">
            ...
            <tr><td> Results for your Query : " <%=request.getParameter("q")%> "</td></tr>
            
            <tr><td><br></td></tr>
            
        <%    for (int i = 0; i < userarray.size(); i++) {
            out.println("<tr><td>"+userarray.get(i).getAsJsonObject().get("name").getAsString()+"</td></tr>");
            out.println("<tr><td>"+userarray.get(i).getAsJsonObject().get("content").getAsString()+"</td></tr>");
